    ...
    <div className="container">
      ...
      <main>
        ...
        <p className="description">
          You have clicked on a malicious link without reading the URL carefully. This would have caused your device to download malicious software or could have enabled an attacker to trick you into giving up your Carsome Credentials.</p>

          <p className="description">At Carsome, we prioritize your online safety and want to ensure that your digital experience remains secure and hassle-free. As part of our ongoing commitment to creating a spam-free environment, we want to equip you with the necessary knowledge and tools to identify and avoid spam effectively.</p>
